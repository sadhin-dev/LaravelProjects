<?php $__env->startSection('head'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('assets/apexcharts/apexcharts.css')); ?>" />
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL('assets/apexcharts/apexcharts.min.js')); ?>"></script>

    <script>
        // Start SEE Connection=================================================
        var sseSource = new EventSource("<?php echo e(URL('/dashboard-sse')); ?>");
        var randomNumber = 0;

        // Function to establish SSE connection
        function establishSSEConnection() {
            sseSource = new EventSource("<?php echo e(URL('/dashboard-sse')); ?>");
        ...
        $('#buySellForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo e(URL('product-transaction-add')); ?>',
                type: 'POST',
                data: formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /run/media/root/WORKING-FILES/4_Need_GitHub_Upload_@sadhin-dev/2_Done_GitHub-Upload_Project_2025/LaravelProjects/resources/views/welcome.blade.php ENDPATH**/ ?>